...
# 数据集地址
path = "/Users/tao626/Documents/workspaces/py-work/tools/face_score/cut_image"
...
# import os
#
# path = "/Users/tao626/Documents/workspaces/py-work/tools/face_score/images/"
#
# # 获取该目录下所有文件，存入列表中
...
# 	# 设置新文件名
# 	newname = path + os.sep + 'SCUT-FBP' + str(n + 1) + '.JPG'
